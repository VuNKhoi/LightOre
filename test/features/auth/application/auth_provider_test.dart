...
void main() {
  group('AuthProvider Tests', () {
    ...
    test('authProvider updates state and returns true when AuthNotifier login succeeds', () async {
      when(() => mockAuthRepository.isAuthenticated()).thenAnswer((_) async => false);
      when(() => mockAuthRepository.setAuthenticated(true)).thenAnswer((_) async => true);
      container = ProviderContainer(overrides: [
        authRepositoryProvider.overrideWith((ref, _) => mockAuthRepository),
        authProvider.overrideWith((ref) => MockAuthNotifier(mockAuthRepository)),
      ]);
    ...
    test('authProvider does not update state and returns false when AuthNotifier login fails', () async {
      when(() => mockAuthRepository.isAuthenticated()).thenAnswer((_) async => null);
      when(() => mockAuthRepository.setAuthenticated(true)).thenAnswer((_) async => false);
      container = ProviderContainer(overrides: [
        authRepositoryProvider.overrideWith((ref, _) => mockAuthRepository),
        authProvider.overrideWith((ref) => MockAuthNotifier(mockAuthRepository)),
      ]);
    ...
    test('authProvider updates state and returns true when AuthNotifier logout succeeds', () async {
      when(() => mockAuthRepository.isAuthenticated()).thenAnswer((_) async => true);
      when(() => mockAuthRepository.setAuthenticated(false)).thenAnswer((_) async => true);
    ...
    test('authProvider does not update state and returns false when AuthNotifier logout fails', () async {
      when(() => mockAuthRepository.isAuthenticated()).thenAnswer((_) async => true);
      when(() => mockAuthRepository.setAuthenticated(false)).thenAnswer((_) async => false);
      when(() => mockAuthRepository.signOut()).thenAnswer((_) async {});
      container = ProviderContainer(overrides: [
        authRepositoryProvider.overrideWith((ref, _) => mockAuthRepository),
        authProvider.overrideWith((ref) => MockAuthNotifier(mockAuthRepository)),
    ...
    test('authProvider updates state and returns true when AuthNotifier setUnknown succeeds', () async {
    ...
    test('authProvider does not update state and returns false when AuthNotifier setUnknown fails', () async {
